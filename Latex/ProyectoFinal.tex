...
=======
\usepackage{listings}
>>>>>>> a9a372a9f42de7615278eb6ab52e9774a0fe8fa0
...
\input{chapter-componentes} % Seleccion de componentes 
\pagebreak

\input{chapter-central} % Central
\pagebreak

\input{chapter-nodos} % Nodos
\pagebreak

\input{chapter-ensayos} % Ensayos
\pagebreak

\input{chapter-server-web} % Servidor web - Corregido
\pagebreak

\input{chapter-conlusion} % Conclusion 
\pagebreak
