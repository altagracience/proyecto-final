...
\subsection{Objetivos globales del sistema}
...
tiempo lógico para la obtención del título, dando la posibilidad de seguir explayándose en el mismo a posterior. \\

De este modo, como objetivos primarios podemos establecer:
